...
const Restaurant = ({key, restaurant, selectedRestaurants, setSelectedRestaurants}) => {
    ...
    // console.log("key: " + key)
    // console.log("restaurant: " + JSON.stringify(restaurant.id));
    ...
    return(
      <div className="restaurant-card">
       <Grid container spacing={3}>
        <Grid item xs={8}>
     <h2 data-testid={"restaurant" + restaurant.id} data-cy="restaurant">{restaurant.name}</h2>
    ...
    <Grid item xs={3}>
  <img src={imgURL}/>
  <Chip label="Add to list" clickable color={btnColor} onClick={handleClick} data-testid="addToPoll" data-cy={"addToPoll" + restaurant.id}/>
  </Grid>
